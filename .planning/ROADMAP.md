...
- [ ] **Phase 11: Config & Postgres Storage** - Unified config and production-grade storage backend
- [ ] **Phase 12: Real LLM Providers & Retry** - OpenAI/Anthropic adapters with retry and token capture
