...
Plans:
- [ ] 18-01-PLAN.md — DispatchSettings merge, ARQ pool + memory factory + cost_estimator bootstrap wiring, cost API prefix fix
...
| 18. Cross-Phase Integration Wiring | v1.1 | 0/2 | Not started | - |
