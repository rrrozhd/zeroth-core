...
Plans:
- [ ] 17-01-PLAN.md — Health probes (readiness/liveness), TLS settings, auth middleware exclusion
- [ ] 17-02-PLAN.md — API versioning (/v1/ prefix), backward-compatible aliases, OpenAPI metadata
...
| 17. Deployment Packaging & Operations | v1.1 | 0/3 | Not started | - |
